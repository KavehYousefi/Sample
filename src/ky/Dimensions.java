...
public class Dimensions
{
  ...
  public double[] getWidthHeightAndDepthAsDoubleArray ()
  {
    return new double[] {width, height, depth};
  }
  
  public double[] getWidthAndHeightAsDoubleArray ()
  {
  ...
  public void setWidthDepthAndHeight (double width, double height, double depth)
  {
    this.width  = width;
    this.height = height;
    this.depth  = depth;
  ...
  {
    setWidthDepthAndHeight (width, height, this.depth);
  }
  
  public void setUniformSize (double dimension)
  {
    setWidthDepthAndHeight (dimension, dimension, dimension);
  }
  ...
  public Dimensions getDivided (Tuple3i divisions)
  {
    Dimensions result     = new Dimensions ();
    double     divisionsX = divisions.getX ();
    double     divisionsY = divisions.getY ();
    double     divisionsZ = divisions.getZ ();
    
    result.setWidth  (this.width  / divisionsX);
    result.setHeight (this.height / divisionsY);
    result.setDepth  (this.depth  / divisionsZ);
  ...
  public static Dimensions createFromWidthHeightAndDepth
  (
    double width,
    double height,
    double depth
  ...
  public static Dimensions createFromWidthAndHeight
  (
    double width,
    double height
  )
  ...
  public static Dimensions createUnitDimensions ()
  {
    return Dimensions.createFromWidthHeightAndDepth (1.0, 1.0, 1.0);
  }
