...
//  private static final Vector3d DEFAULT_SCALING_FACTORS = new Vector3d (-0.005, 0.005, 0.005);
  private static final Vector3d DEFAULT_SCALING_FACTORS = new Vector3d (-0.002, 0.004, 0.003);
...
//    transformGroup.setTransform  (createInitialTransform ());
    ...
    textShape3D.setAppearance     (DefaultMaterials.getAppearance (MaterialName.COLE_GOLD));
