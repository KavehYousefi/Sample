...
public class DiskBoundsRenderer
{
  ...
  public DiskBoundsRenderer (double radius, int cornerPointCount)
  {
    ...
    this.transparencyInterpolator = createTransparencyInterpolator ();
    
    groupHierarchy.getVisibilitySwitchGroup ().addChild (diskShape3D);
    groupHierarchy.getVisibilitySwitchGroup ().addChild (transparencyInterpolator);
  }
  ...
  {
    return this.diskShape3D.getAppearance ();
  }
  ...
  public void setVisible (boolean isVisible)
  {
    if (isVisible)
    {
      groupHierarchy.getVisibilitySwitchGroup ().setWhichChild (Switch.CHILD_ALL);
    }
    else
    {
      groupHierarchy.getVisibilitySwitchGroup ().setWhichChild (Switch.CHILD_NONE);
    }
  }
