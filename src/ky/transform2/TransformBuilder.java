...
public class TransformBuilder
{
  ...
  public GeneralTransform rotateAroundEdge
  (
    Position endpoint1,
    Position endpoint2,
    Angle    angle
  ...
  {
    GeneralTransform transformObject = null;
    Transform3D      transform3D     = null;
    
    transformObject = new GeneralTransform ();
    transform3D     = TransformUtils.rotateAroundEdge
    (
      endpoint1,
      endpoint2,
      angle
    ...
    transformObject.setTransform3D (transform3D);
  ...
  /**
   * <div class="introMethod">
   *   Appends a <code>Transform3D</code>.
   * </div>
   * 
   * @param transform3D  The <code>Transform3D</code> to be added.
   *                     It may not be <code>null</code>.
   * 
   * @throws NullPointerException  If the <code>transform3D</code>
   *                               equals <code>null</code>.
   */
  public void addTransform3D (Transform3D transform3D)
  {
    CheckingUtils.checkForNull (transform3D, "Transform3D is null.");
    addTransform (GeneralTransform.createFromTransform3D (transform3D));
  }
  
  /**
   * <div class="introMethod">
   *   Appends a <code>AffineTransform</code>.
   * </div>
   * 
   * @param affineTransform  The <code>AffineTransform</code> to be
   *                         added.
   *                         It may not be <code>null</code>.
   * 
   * @throws NullPointerException  If the <code>affineTransform</code>
   *                               equals <code>null</code>.
   */
  public void addAffineTransform (AffineTransform affineTransform)
  {
    ...
    (
      affineTransform,
      "AffineTransform is null."
    );
    addTransform (GeneralTransform.createFromAffineTransform (affineTransform));
  }
