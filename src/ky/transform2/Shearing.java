...
implements   TransformObject
{
  ...
  public static Shearing createFromAffineTransform (AffineTransform affineTransform)
  {
    Shearing shearing = null;
    
    shearing = new Shearing    ();
    shearing.setShearFactorX2D (affineTransform.getShearX ());
    shearing.setShearFactorY2D (affineTransform.getShearY ());
